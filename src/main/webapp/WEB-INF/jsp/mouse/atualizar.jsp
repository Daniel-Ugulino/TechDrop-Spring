        ...
        <form action="/mouse/atualizar/${mouse.getId()}" method="post" enctype="multipart/form-data" class="row d-flex justify-content-center pt-3" style="gap:20px">
            <div class="col d-flex flex-column" style="gap:10px">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="marca" value="${mouse.getMarca()}" id="marca" placeholder="name@example.com">
                </div>

                <div>
                    <label for="modelo"  class="form-label">Modelo</label>
                    <input type="text" class="form-control" name="modelo" value="${mouse.getModelo()}" id="modelo" placeholder="name@example.com">
                </div>

                <div>
                    <label for="quantidade" class="form-label">Quantidade</label>
                    <input type="text" class="form-control" name="quantidade" value="${mouse.getQuantidade()}" id="quantidade" placeholder="name@example.com">
                </div>

                <div>
                    <label for="valor" class="form-label">Valor</label>
                    <input type="text" class="form-control" name="valor" value="${mouse.getValor()}" id="valor" placeholder="name@example.com">
                </div>

                <div class="d-flex" style="gap:15px">
                    <p>Conexão:</p>
                    <div class="form-check d-flex" style="gap:10px">
                        <input ${mouse.getBluetooh_cable().equals("bluetooh") ? 'checked="checked"' : ''} class="form-check-input" type="radio" name="bluetooh_cable" id="bluetooh_cable" value="bluetooh">
                    ...
                    <div class="form-check d-flex" style="gap:10px">
                        <input ${mouse.getBluetooh_cable().equals("cable") ? 'checked="checked"' : ''} class="form-check-input" type="radio" name="bluetooh_cable" id="bluetooh_cable" value="cable">
                        <label class="form-check-label" for="bluetooh_cable">
                            Cable
                        </label>
                    </div>
                ...
                <div class="d-flex" style="gap:15px">
                    <p>Iluminação:</p>
                    <div class="form-check d-flex" style="gap:10px">
                        <input ${mouse.getIluminacao() ? 'checked="checked"' : ''} class="form-check-input" type="radio" name="iluminacao" id="iluminacao" value="true">
            ...
            <div class="col d-flex flex-column" style="gap:10px">
                ...
                <div>
                    ...
                    <input type="number" value="${mouse.getDpi()}" class="form-control" name="dpi" id="dpi" placeholder="1200">
                </div>

                <div>
                    <label for="dpi" class="form-label">Quantidade de Botões</label>
                    <input type="number" value="${mouse.getQtd_botoes()}" class="form-control" name="qtd_botoes" id="qtd_botoes" placeholder="5">
                </div>

                <div>
                    <label for="dpi" class="form-label">Peso em gramas</label>
                    <input type="number" value="${mouse.getPeso()}" class="form-control" name="peso" id="peso" placeholder="1200">
                </div>
            </div>
