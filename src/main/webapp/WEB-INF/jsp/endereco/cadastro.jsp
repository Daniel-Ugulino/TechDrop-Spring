...
<div class="col d-flex flex-column" style="gap:10px">
    ...
    <div>
        ...
        <input required type="text" value="{}" class="form-control" name="cep" id="cep" placeholder="000000-000">
    </div>
    ...
    <div>
        ...
        <input required type="text" class="form-control" name="localidade" id="localidade">
    </div>

    <div>
        <label for="uf"  class="form-label">UF</label>
        <input required type="text" class="form-control" name="uf" id="uf">
    </div>
</div>